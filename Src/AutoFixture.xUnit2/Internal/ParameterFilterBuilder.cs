...
{
    internal class ParameterFilterBuilder
    {
        private readonly ParameterInfo parameterInfo;

        public ParameterFilterBuilder(ParameterInfo parameterInfo)
        {
        ...
        public ParameterFilterBuilder SetFlags(Matching flags)
        {
        ...
        public IRequestSpecification Build()
        {
            ...
            return new OrRequestSpecification(specifications);
        }
