...
namespace Ploeh.AutoFixture.NUnit2
{
    ...
    /// </summary>
    [NUnitAddin(Name = AutoDataExtension, Description = "Provides auto-generated data specimens generated by AutoFixture as an extention to NUnit TestCase attribute.", Type = ExtensionType.Core | ExtensionType.Gui | ExtensionType.Client)]
    public class Addin : IAddin
    {
        /// <summary>
        /// The name by which the NUnit Addin is identified.
        /// </summary>
