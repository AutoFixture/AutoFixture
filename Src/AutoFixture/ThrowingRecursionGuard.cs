...
namespace Ploeh.AutoFixture
{
	...
	public class ThrowingRecursionGuard : RecursionGuard
	{
		...
		public ThrowingRecursionGuard(ISpecimenBuilder builder, IEqualityComparer comparer) : base(builder, comparer)
		{
		}
		...
		public ThrowingRecursionGuard(ISpecimenBuilder builder) : base(builder)
		{
		}
