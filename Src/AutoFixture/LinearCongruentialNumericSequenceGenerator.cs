...
namespace AutoFixture
{
    ...
    /// </summary>
    public class LinearCongruentialNumericSequenceGenerator : ISpecimenBuilder
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearCongruentialNumericSequenceGenerator" /> class
        /// with the default limits, 255, 32767, and 2147483647.
        /// </summary>
        public LinearCongruentialNumericSequenceGenerator()
        ...
        public LinearCongruentialNumericSequenceGenerator(IEnumerable<long> limits)
            : this(limits.ToArray())
        {
        }
        ...
        public LinearCongruentialNumericSequenceGenerator(params long[] limits)
        {
