...
namespace Ploeh.AutoFixture.IdiomsUnitTest
{
    public class GuidGuardSpecificationTest
    {
        ...
        public void SutIsITypeGuardSpecification()
        {
            // Fixture setup
            // Exercise system
            var sut = System.Runtime.Serialization.FormatterServices.GetUninitializedObject(typeof(GuidGuardSpecification));
            // Verify outcome
        ...
        public void IsSatisfiedByReturnsCorrectResultForGuidType()
        {
            ...
            // Verify outcome
            Assert.IsType<GuidValueGuardConvention>(result);
            // Teardown
        }
