...
namespace Ploe.AutoFixture.NUnit.UnitTest
{
    ...
    public class CompositeDataAttributeSufficientDataTest : IEnumerable<object[]>
    {
        ...
        [Test]
        [TestCaseSource(typeof(CompositeDataAttributeSufficientDataTest))]
        ...
        public IEnumerator<object[]> GetEnumerator()
        {
            ...
            yield return CreateTestCase(
                data: new[]
                    {
                        new FakeDataAttribute(method, parameterTypes, new[] { new object[] { 1, 2, 3 }, new object[] { 4,  5, 6 }                          }),
                        new FakeDataAttribute(method, parameterTypes, new[] { new object[] { 7, 8    }, new object[] { 9, 10    }, new object[] { 11, 12 } })
                    },
                expected: new[] 
                    {
                        new object[] { 1, 2, 3 }, new object[] { 4, 5, 6 }
            ...
            yield return CreateTestCase(
                data: new[]
                    {
                        new FakeDataAttribute(method, parameterTypes, new[] { new object[] { 1, 2    }, new object[] {  3,  4     }, new object[] {  5,  6     } }),
                        new FakeDataAttribute(method, parameterTypes, new[] { new object[] { 7, 8, 9 }, new object[] { 10, 11, 12 }, new object[] { 13, 14, 15 } })
                    },
                expected: new[] 
                    {
