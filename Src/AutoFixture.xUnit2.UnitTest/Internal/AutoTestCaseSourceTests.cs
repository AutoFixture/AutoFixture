...
{
    public class AutoTestCaseSourceTests
    {
        [Fact]
        public void SutIsTestCaseSource()
        {
            // Arrange & Act
            var sut = new AutoTestCaseSource(() => new DelegatingFixture());
        ...
        public void SetsPropertiesToExpectedValues()
        {
            ...
            var source = new DelegatingTestCaseSource();

            // Act
            var sut = new AutoTestCaseSource(fixtureFactory, source);
        ...
        [Fact]
        public void GeneratesTestCasesUsingFixture()
        {
            // Arrange
        ...
        [Fact]
        public void CombinesTestCasesFromSourceWithAutoGeneratedValues()
        {
            // Arrange
            var source = new DelegatingTestCaseSource
            {
        ...
        [Fact]
        public void ReturnsNoTestCasesWhenSourceReturnsNoTestCases()
        {
            // Arrange
            var source = new DelegatingTestCaseSource
            {
