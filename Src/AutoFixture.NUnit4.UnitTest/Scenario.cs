...
namespace AutoFixture.NUnit4.UnitTest
{
    ...
    public class Scenario
    {
        ...
        {
            Assert.That(ph, Is.Not.Null);
            Assert.That(ph.Property, Is.Not.Null);
        }
        ...
        public void AutoTestCaseProvidesMultipleObjects(PropertyHolder<Version> ph, SingleParameterType<ConcreteType> spt)
        {
            ...
            Assert.That(spt, Is.Not.Null);
            Assert.That(spt.Parameter, Is.Not.Null);
        }
        ...
        public void FreezeSecondParameterOnlyFreezesSubsequentParameters(Guid g1, [Frozen]Guid g2, Guid g3)
        {
            ...
            Assert.That(g3, Is.Not.EqualTo(g1));

            Assert.That(g3, Is.EqualTo(g2));
        }
        ...
        {
            Assert.That(string.IsNullOrEmpty(p.Text), Is.True);
        ...
        {
            Assert.That(string.IsNullOrEmpty(p.Text), Is.False);
            Assert.That(p.Number, Is.Not.EqualTo(0));
        }
        ...
        {
            Assert.That(string.IsNullOrEmpty(p2.Text), Is.False);
            Assert.That(p2.Number, Is.Not.EqualTo(0));
        }
        ...
        {
            Assert.That(numbers.SequenceEqual(container.Items), Is.True);
        }
        ...
        {
            Assert.That(p2.Parameter, Is.EqualTo(parameter));
        }
        ...
        public void FreezeFirstParameterByParameterWithDifferentNameShouldNotAssignSameInstanceToSecondParameter(
            ...
            SingleParameterType<object> p2)
        {
            Assert.That(p2.Parameter, Is.Not.EqualTo(p1));
        }
        ...
        {
            Assert.That(p2.Property, Is.EqualTo(property));
        }
        ...
        public void FreezeFirstParameterByPropertyWithDifferentNameShouldNotAssignSameInstanceToSecondParameter(
            ...
            PropertyHolder<object> p2)
        {
            Assert.That(p2.Property, Is.Not.EqualTo(p1));
        }
        ...
        {
            Assert.That(p2.Field, Is.EqualTo(field));
        }
        ...
        public void FreezeFirstParameterByFieldWithDifferentNameShouldNotAssignSameInstanceToSecondParameter(
            ...
            FieldHolder<object> p2)
        {
            Assert.That(p2.Field, Is.Not.EqualTo(p1));
        }
        ...
        {
            Assert.That(p.Length == 3, Is.True);
        }
