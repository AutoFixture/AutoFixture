...
#pragma warning restore 612
        ...
        public void BuildFromDontActivateFixtureIfArgsValuesAreNotUsedByTestBuilder()
        {
            ...
            // Assert
            Assert.That(wasActivated, Is.False);
        }
        ...
        public void InitializedWithArgumentsHasCorrectArguments()
        {
            ...
            // Assert
            Assert.That(result, Is.SameAs(expectedArguments));
        }
        ...
        public void GetDataOrdersCustomizationAttributes(string methodName)
        {
            ...
            // Assert
            Assert.That(customizationLog[0] is FreezeOnMatchCustomization, Is.False);
            Assert.That(customizationLog[1] is FreezeOnMatchCustomization, Is.True);
        }
        ...
        public void ShouldRecognizeAttributesImplementingIParameterCustomizationSource()
        {
            ...
            // Assert
            Assert.That(customizationLog[0] is TypeWithIParameterCustomizationSourceUsage.Customization, Is.True);
        }
    }
}