...
public class RegularExpressionGeneratorTest
{
    ...
    {
        AssertRegularExpressionGeneratorOutputMatches(pattern);
    }
    ...
    public void CreateWithRegularExpressionRequestReturnsCorrectResult_ForHeavyPatterns(string pattern)
    {
        AssertRegularExpressionGeneratorOutputMatches(pattern);
    }
    ...
    private static void AssertRegularExpressionGeneratorOutputMatches(string pattern)
    {
        var sut = new RegularExpressionGenerator();
        var request = new RegularExpressionRequest(pattern);
        var dummyContext = new DelegatingSpecimenContext();
